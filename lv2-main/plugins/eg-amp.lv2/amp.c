...
//LEFT OFF HERE <---
// I can make this into a C++ project directly it looks like! then define a standard export
// wrapper and never have to touch this plain C code again.
//
// Also go install Jalv, it is available for Windows. Looks like it just makes audio ports
// available, so I might also need Jack or some other routing software to connect it up
// to my system I/O.
//
// And keep watching those tutorial videos... those things rock and talk about weird things
// I didn't think of.