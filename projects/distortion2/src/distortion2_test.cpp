...
static void runSoundTest(bool automation)
{
	...
	test.setControlValue(1, 50.0f);		//shape
	test.setControlValue(2, 50.0f);		//tone
	test.setControlValue(3, 50.0f);		//dirty
	test.setControlValue(4, 50.0f);		//color
	test.setControlValue(5, 75.0f);		//level
	if (automation) {
...
int main()
{
	...
	//LEFT OFF HERE <-- actually listen and profile and stuff!
