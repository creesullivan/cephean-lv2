...
static void runSoundTest(bool automation)
{
	...
	//controls
	test.setControlValue(0, 8000.0f);		//freq1
	test.setControlValue(1, 12.0f);		//res1
	test.setControlValue(2, 3000.0f);		//freq2
	test.setControlValue(3, -6.0f);		//res2
	test.setControlValue(4, 0.0f);		//gain
	if (automation) {
...
static void runStressTest(bool automation)
{
	...
	//controls
	test.setControlValue(0, 8000.0f);		//freq1
	test.setControlValue(1, 0.0f);		//res1
	test.setControlValue(2, 2000.0f);		//freq2
	test.setControlValue(3, 0.0f);		//res2
	test.setControlValue(4, 0.0f);		//gain
	if (automation) {
